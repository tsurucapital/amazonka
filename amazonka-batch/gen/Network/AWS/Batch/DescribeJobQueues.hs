...
describeJobQueues = DescribeJobQueues' { _djqNextToken  = Nothing
...
djqJobQueues =
  lens _djqJobQueues (\s a -> s { _djqJobQueues = a }) . _Default . _Coerce
...
instance AWSPager DescribeJobQueues where
  page rq rs | stop (rs ^. djqsrsNextToken) = Nothing
...
instance ToJSON DescribeJobQueues where
  toJSON DescribeJobQueues' {..} = object
    (catMaybes
...
describeJobQueuesResponse
  ...
  -> DescribeJobQueuesResponse
describeJobQueuesResponse pResponseStatus_ = DescribeJobQueuesResponse'
...
djqsrsJobQueues =
  lens _djqsrsJobQueues (\s a -> s { _djqsrsJobQueues = a })
    . _Default
    . _Coerce
...
djqsrsResponseStatus =
  lens _djqsrsResponseStatus (\s a -> s { _djqsrsResponseStatus = a })
