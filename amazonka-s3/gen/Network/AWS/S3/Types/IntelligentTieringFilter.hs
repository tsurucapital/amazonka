...
data IntelligentTieringFilter = IntelligentTieringFilter'{_itfTag
                                                          :: !(Maybe Tag),
                                                          _itfPrefix ::
                                                          !(Maybe Text),
                                                          _itfAnd ::
...
intelligentTieringFilter = IntelligentTieringFilter' { _itfTag    = Nothing
                                                     , _itfPrefix = Nothing
                                                     , _itfAnd    = Nothing
                                                     }
...
instance ToXML IntelligentTieringFilter where
  toXML IntelligentTieringFilter' {..} =
    mconcat ["Tag" @= _itfTag, "Prefix" @= _itfPrefix, "And" @= _itfAnd]
