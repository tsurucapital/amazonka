...
data GetBucketMetricsConfiguration = GetBucketMetricsConfiguration'{_gbmcExpectedBucketOwner
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _gbmcBucket
...
getBucketMetricsConfiguration
  ...
  -> Text -- ^ 'gbmcId'
  -> GetBucketMetricsConfiguration
getBucketMetricsConfiguration pBucket_ pId_ = GetBucketMetricsConfiguration'
  { _gbmcExpectedBucketOwner = Nothing
...
gbmcExpectedBucketOwner =
  lens _gbmcExpectedBucketOwner (\s a -> s { _gbmcExpectedBucketOwner = a })
...
instance ToHeaders GetBucketMetricsConfiguration
  ...
  toHeaders GetBucketMetricsConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gbmcExpectedBucketOwner]
...
gbmcrsMetricsConfiguration = lens
  _gbmcrsMetricsConfiguration
  (\s a -> s { _gbmcrsMetricsConfiguration = a })
