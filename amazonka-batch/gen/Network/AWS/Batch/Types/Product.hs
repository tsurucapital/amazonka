...
instance ToJSON ArrayProperties where
  toJSON ArrayProperties' {..} = object (catMaybes [("size" .=) <$> _apSize])
...
arrayPropertiesDetail = ArrayPropertiesDetail' { _apdSize          = Nothing
...
apdStatusSummary =
  lens _apdStatusSummary (\s a -> s { _apdStatusSummary = a }) . _Default . _Map
...
instance FromJSON ArrayPropertiesSummary where
  parseJSON = withObject
    "ArrayPropertiesSummary"
    (\x -> ArrayPropertiesSummary' <$> (x .:? "size") <*> (x .:? "index"))
...
acdContainerInstanceARN =
  lens _acdContainerInstanceARN (\s a -> s { _acdContainerInstanceARN = a })
...
attemptDetail = AttemptDetail' { _adStoppedAt    = Nothing
...
cedComputeResources =
  lens _cedComputeResources (\s a -> s { _cedComputeResources = a })
...
cedComputeEnvironmentName =
  lens _cedComputeEnvironmentName (\s a -> s { _cedComputeEnvironmentName = a })

-- | The Amazon Resource Name (ARN) of the compute environment.
cedComputeEnvironmentARN :: Lens' ComputeEnvironmentDetail Text
cedComputeEnvironmentARN =
  lens _cedComputeEnvironmentARN (\s a -> s { _cedComputeEnvironmentARN = a })
...
computeEnvironmentOrder
  ...
  -> ComputeEnvironmentOrder
computeEnvironmentOrder pOrder_ pComputeEnvironment_ = ComputeEnvironmentOrder'
  { _ceoOrder              = pOrder_
...
ceoComputeEnvironment =
  lens _ceoComputeEnvironment (\s a -> s { _ceoComputeEnvironment = a })
...
instance ToJSON ComputeEnvironmentOrder where
  toJSON ComputeEnvironmentOrder' {..} = object
    (catMaybes
...
computeResource
  ...
  -> Text -- ^ 'crInstanceRole'
  -> ComputeResource
computeResource pType_ pMinvCPUs_ pMaxvCPUs_ pInstanceRole_ = ComputeResource'
...
crInstanceTypes =
  lens _crInstanceTypes (\s a -> s { _crInstanceTypes = a }) . _Coerce
...
crSecurityGroupIds =
  lens _crSecurityGroupIds (\s a -> s { _crSecurityGroupIds = a }) . _Coerce
...
computeResourceUpdate = ComputeResourceUpdate' { _cruMinvCPUs     = Nothing
...
containerProperties
  ...
  -> Int -- ^ 'cpMemory'
  -> ContainerProperties
containerProperties pImage_ pVcpus_ pMemory_ = ContainerProperties'
  { _cpCommand                = Nothing
...
instance FromJSON ContainerSummary where
  parseJSON = withObject
    "ContainerSummary"
    (\x -> ContainerSummary' <$> (x .:? "reason") <*> (x .:? "exitCode"))
...
instance FromJSON Host where
  parseJSON = withObject "Host" (\x -> Host' <$> (x .:? "sourcePath"))
...
instance ToJSON Host where
  toJSON Host' {..} = object (catMaybes [("sourcePath" .=) <$> _hSourcePath])
...
instance ToJSON JobDependency where
  toJSON JobDependency' {..} =
    object (catMaybes [("jobId" .=) <$> _jJobId, ("type" .=) <$> _jType])
...
jobDetail pJobName_ pJobId_ pJobQueue_ pStatus_ pStartedAt_ pJobDefinition_ =
  JobDetail' { _jdStoppedAt       = Nothing
...
jobQueueDetail pJobQueueName_ pJobQueueARN_ pState_ pPriority_ =
  JobQueueDetail' { _jqdStatus                  = Nothing
...
jqdComputeEnvironmentOrder =
  lens _jqdComputeEnvironmentOrder
       (\s a -> s { _jqdComputeEnvironmentOrder = a })
    . _Coerce
...
jobSummary
  ...
  -> Text -- ^ 'jsJobName'
  -> JobSummary
jobSummary pJobId_ pJobName_ = JobSummary' { _jsStoppedAt       = Nothing
                                           , _jsStatus          = Nothing
...
jsArrayProperties =
  lens _jsArrayProperties (\s a -> s { _jsArrayProperties = a })
...
instance ToJSON KeyValuePair where
  toJSON KeyValuePair' {..} =
    object (catMaybes [("value" .=) <$> _kvpValue, ("name" .=) <$> _kvpName])
...
mountPoint = MountPoint' { _mpContainerPath = Nothing
...
instance FromJSON RetryStrategy where
  parseJSON =
    withObject "RetryStrategy" (\x -> RetryStrategy' <$> (x .:? "attempts"))
...
instance ToJSON RetryStrategy where
  toJSON RetryStrategy' {..} =
    object (catMaybes [("attempts" .=) <$> _rsAttempts])
...
ulimit
  ...
  -> Int -- ^ 'uSoftLimit'
  -> Ulimit
ulimit pHardLimit_ pName_ pSoftLimit_ = Ulimit' { _uHardLimit = pHardLimit_
                                                , _uName      = pName_
...
instance FromJSON Ulimit where
  parseJSON = withObject
    "Ulimit"
    (\x ->
      Ulimit' <$> (x .: "hardLimit") <*> (x .: "name") <*> (x .: "softLimit")
    )
...
instance FromJSON Volume where
  parseJSON =
    withObject "Volume" (\x -> Volume' <$> (x .:? "name") <*> (x .:? "host"))
...
instance ToJSON Volume where
  toJSON Volume' {..} =
    object (catMaybes [("name" .=) <$> _vName, ("host" .=) <$> _vHost])
