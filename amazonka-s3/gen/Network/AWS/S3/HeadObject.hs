...
data HeadObject = HeadObject'{_hoIfMatch ::
                              !(Maybe Text),
                              ...
                              _hoBucket :: !BucketName, _hoKey :: !ObjectKey}
...
headObject
  ...
  -> ObjectKey -- ^ 'hoKey'
  -> HeadObject
headObject pBucket_ pKey_ = HeadObject' { _hoIfMatch              = Nothing
...
hoIfModifiedSince =
  lens _hoIfModifiedSince (\s a -> s { _hoIfModifiedSince = a }) . mapping _Time
...
hoExpectedBucketOwner =
  lens _hoExpectedBucketOwner (\s a -> s { _hoExpectedBucketOwner = a })
...
instance ToPath HeadObject where
  toPath HeadObject' {..} = mconcat ["/", toBS _hoBucket, "/", toBS _hoKey]

instance ToQuery HeadObject where
  toQuery HeadObject' {..} =
    mconcat ["versionId" =: _hoVersionId, "partNumber" =: _hoPartNumber]

-- | /See:/ 'headObjectResponse' smart constructor.
data HeadObjectResponse = HeadObjectResponse'{_horsRequestCharged
                                              ...
                                              _horsArchiveStatus ::
                                              !(Maybe ArchiveStatus),
                                              _horsSSECustomerAlgorithm ::
                                              !(Maybe Text),
                                              _horsMissingMeta :: !(Maybe Int),
                                              _horsBucketKeyEnabled ::
                                              !(Maybe Bool),
                                              _horsWebsiteRedirectLocation ::
                                              !(Maybe Text),
                                              _horsAcceptRanges ::
                                              !(Maybe Text),
                                              _horsStorageClass ::
                                              !(Maybe StorageClass),
                                              _horsSSECustomerKeyMD5 ::
                                              !(Maybe Text),
                                              _horsSSEKMSKeyId ::
                                              !(Maybe (Sensitive Text)),
                                              _horsContentEncoding ::
                                              !(Maybe Text),
                                              _horsObjectLockRetainUntilDate ::
                                              !(Maybe ISO8601),
                                              _horsMetadata :: !(Map Text Text),
                                              _horsReplicationStatus ::
                                              !(Maybe ReplicationStatus),
                                              _horsCacheControl ::
                                              !(Maybe Text),
                                              _horsContentLanguage ::
                                              !(Maybe Text),
                                              _horsLastModified ::
                                              !(Maybe ISO8601),
...
--
-- * 'horsBucketKeyEnabled' - Indicates whether the object uses an S3 Bucket Key for server-side encryption with AWS KMS (SSE-KMS).
--
...
headObjectResponse
  ...
  -> HeadObjectResponse
headObjectResponse pResponseStatus_ = HeadObjectResponse'
...
horsRequestCharged =
  lens _horsRequestCharged (\s a -> s { _horsRequestCharged = a })
...
horsObjectLockMode =
  lens _horsObjectLockMode (\s a -> s { _horsObjectLockMode = a })

-- | The date and time at which the object is no longer cacheable.
horsExpires :: Lens' HeadObjectResponse (Maybe UTCTime)
horsExpires =
  lens _horsExpires (\s a -> s { _horsExpires = a }) . mapping _Time
...
horsArchiveStatus =
  lens _horsArchiveStatus (\s a -> s { _horsArchiveStatus = a })

-- | If server-side encryption with a customer-provided encryption key was requested, the response will include this header confirming the encryption algorithm used.
horsSSECustomerAlgorithm :: Lens' HeadObjectResponse (Maybe Text)
horsSSECustomerAlgorithm =
  lens _horsSSECustomerAlgorithm (\s a -> s { _horsSSECustomerAlgorithm = a })
...
horsBucketKeyEnabled :: Lens' HeadObjectResponse (Maybe Bool)
horsBucketKeyEnabled =
  lens _horsBucketKeyEnabled (\s a -> s { _horsBucketKeyEnabled = a })

-- | If the bucket is configured as a website, redirects requests for this object to another object in the same bucket or to an external URL. Amazon S3 stores the value of this header in the object metadata.
horsWebsiteRedirectLocation :: Lens' HeadObjectResponse (Maybe Text)
horsWebsiteRedirectLocation = lens
  _horsWebsiteRedirectLocation
...
horsSSEKMSKeyId = lens _horsSSEKMSKeyId (\s a -> s { _horsSSEKMSKeyId = a })
  . mapping _Sensitive
...
horsObjectLockRetainUntilDate =
  lens _horsObjectLockRetainUntilDate
       (\s a -> s { _horsObjectLockRetainUntilDate = a })
    . mapping _Time
...
horsReplicationStatus =
  lens _horsReplicationStatus (\s a -> s { _horsReplicationStatus = a })
...
horsLastModified =
  lens _horsLastModified (\s a -> s { _horsLastModified = a }) . mapping _Time

-- | Specifies whether a legal hold is in effect for this object. This header is only returned if the requester has the @s3:GetObjectLegalHold@ permission. This header is not returned if the specified version of this object has never had a legal hold applied. For more information about S3 Object Lock, see <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html Object Lock> .
horsObjectLockLegalHoldStatus
  :: Lens' HeadObjectResponse (Maybe ObjectLockLegalHoldStatus)
horsObjectLockLegalHoldStatus = lens
  _horsObjectLockLegalHoldStatus
  (\s a -> s { _horsObjectLockLegalHoldStatus = a })
...
horsServerSideEncryption
  :: Lens' HeadObjectResponse (Maybe ServerSideEncryption)
horsServerSideEncryption =
  lens _horsServerSideEncryption (\s a -> s { _horsServerSideEncryption = a })
...
horsResponseStatus =
  lens _horsResponseStatus (\s a -> s { _horsResponseStatus = a })
