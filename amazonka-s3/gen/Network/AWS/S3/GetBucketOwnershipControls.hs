...
data GetBucketOwnershipControls = GetBucketOwnershipControls'{_gbocExpectedBucketOwner
                                                              :: !(Maybe Text),
                                                              _gbocBucket ::
                                                              !BucketName}
...
getBucketOwnershipControls
  :: BucketName -- ^ 'gbocBucket'
  -> GetBucketOwnershipControls
getBucketOwnershipControls pBucket_ = GetBucketOwnershipControls'
...
gbocExpectedBucketOwner =
  lens _gbocExpectedBucketOwner (\s a -> s { _gbocExpectedBucketOwner = a })
...
instance AWSRequest GetBucketOwnershipControls where
  type Rs GetBucketOwnershipControls = GetBucketOwnershipControlsResponse
  request  = get s3
  response = receiveXML
    (\s h x ->
      GetBucketOwnershipControlsResponse'
...
instance Hashable GetBucketOwnershipControls where

instance NFData GetBucketOwnershipControls where

instance ToHeaders GetBucketOwnershipControls where
  toHeaders GetBucketOwnershipControls' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gbocExpectedBucketOwner]

instance ToPath GetBucketOwnershipControls where
  toPath GetBucketOwnershipControls' {..} = mconcat ["/", toBS _gbocBucket]
...
data GetBucketOwnershipControlsResponse = GetBucketOwnershipControlsResponse'{_gbocrsOwnershipControls
                                                                              ::
                                                                              !(Maybe
                                                                                  OwnershipControls),
...
getBucketOwnershipControlsResponse
  :: Int -- ^ 'gbocrsResponseStatus'
  -> GetBucketOwnershipControlsResponse
getBucketOwnershipControlsResponse pResponseStatus_ =
  GetBucketOwnershipControlsResponse' { _gbocrsOwnershipControls = Nothing
...
gbocrsOwnershipControls
  :: Lens' GetBucketOwnershipControlsResponse (Maybe OwnershipControls)
gbocrsOwnershipControls =
  lens _gbocrsOwnershipControls (\s a -> s { _gbocrsOwnershipControls = a })

-- | -- | The response status code.
gbocrsResponseStatus :: Lens' GetBucketOwnershipControlsResponse Int
gbocrsResponseStatus =
  lens _gbocrsResponseStatus (\s a -> s { _gbocrsResponseStatus = a })
