...
getObjectTagging
  ...
  -> ObjectKey -- ^ 'gotoKey'
  -> GetObjectTagging
getObjectTagging pBucket_ pKey_ = GetObjectTagging'
...
gotoExpectedBucketOwner =
  lens _gotoExpectedBucketOwner (\s a -> s { _gotoExpectedBucketOwner = a })
...
instance ToHeaders GetObjectTagging where
  toHeaders GetObjectTagging' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gotoExpectedBucketOwner]
...
getObjectTaggingResponse
  ...
  -> GetObjectTaggingResponse
getObjectTaggingResponse pResponseStatus_ = GetObjectTaggingResponse'
...
gotrsResponseStatus =
  lens _gotrsResponseStatus (\s a -> s { _gotrsResponseStatus = a })
