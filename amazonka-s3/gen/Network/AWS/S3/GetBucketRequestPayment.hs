...
data GetBucketRequestPayment = GetBucketRequestPayment'{_gbrpExpectedBucketOwner
                                                        :: !(Maybe Text),
                                                        _gbrpBucket ::
                                                        !BucketName}
...
getBucketRequestPayment
  ...
  -> GetBucketRequestPayment
getBucketRequestPayment pBucket_ = GetBucketRequestPayment'
...
gbrpExpectedBucketOwner =
  lens _gbrpExpectedBucketOwner (\s a -> s { _gbrpExpectedBucketOwner = a })
...
instance ToHeaders GetBucketRequestPayment where
  toHeaders GetBucketRequestPayment' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gbrpExpectedBucketOwner]
...
getBucketRequestPaymentResponse pResponseStatus_ =
  GetBucketRequestPaymentResponse' { _gbrprsPayer          = Nothing
