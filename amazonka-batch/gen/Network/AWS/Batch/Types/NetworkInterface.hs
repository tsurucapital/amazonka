...
data NetworkInterface = NetworkInterface'{_niIpv6Address
                                          :: !(Maybe Text),
...
networkInterface = NetworkInterface' { _niIpv6Address        = Nothing
...
niPrivateIPv4Address =
  lens _niPrivateIPv4Address (\s a -> s { _niPrivateIPv4Address = a })
