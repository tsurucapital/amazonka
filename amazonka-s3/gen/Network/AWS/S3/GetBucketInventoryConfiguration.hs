...
data GetBucketInventoryConfiguration = GetBucketInventoryConfiguration'{_gbicExpectedBucketOwner
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _gbicBucket
...
getBucketInventoryConfiguration pBucket_ pId_ =
  GetBucketInventoryConfiguration' { _gbicExpectedBucketOwner = Nothing
...
gbicExpectedBucketOwner =
  lens _gbicExpectedBucketOwner (\s a -> s { _gbicExpectedBucketOwner = a })
...
instance ToHeaders GetBucketInventoryConfiguration
  ...
  toHeaders GetBucketInventoryConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gbicExpectedBucketOwner]
...
gbicrsInventoryConfiguration = lens
