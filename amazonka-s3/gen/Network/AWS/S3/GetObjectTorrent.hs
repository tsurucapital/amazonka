...
getObjectTorrent
  ...
  -> ObjectKey -- ^ 'gotKey'
  -> GetObjectTorrent
getObjectTorrent pBucket_ pKey_ = GetObjectTorrent'
...
gotExpectedBucketOwner =
  lens _gotExpectedBucketOwner (\s a -> s { _gotExpectedBucketOwner = a })
...
getObjectTorrentResponse
  ...
  -> RsBody -- ^ 'getrsBody'
  -> GetObjectTorrentResponse
getObjectTorrentResponse pResponseStatus_ pBody_ = GetObjectTorrentResponse'
...
getrsRequestCharged =
  lens _getrsRequestCharged (\s a -> s { _getrsRequestCharged = a })
