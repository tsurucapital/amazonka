...
createJobQueue
  ...
  -> Int -- ^ 'cjqPriority'
  -> CreateJobQueue
createJobQueue pJobQueueName_ pPriority_ = CreateJobQueue'
  { _cjqState                   = Nothing
  , _cjqTags                    = Nothing
...
cjqComputeEnvironmentOrder =
  lens _cjqComputeEnvironmentOrder
       (\s a -> s { _cjqComputeEnvironmentOrder = a })
    . _Coerce
...
createJobQueueResponse pResponseStatus_ pJobQueueName_ pJobQueueARN_ =
  CreateJobQueueResponse' { _cjqrsResponseStatus = pResponseStatus_
...
cjqrsResponseStatus =
  lens _cjqrsResponseStatus (\s a -> s { _cjqrsResponseStatus = a })

-- | The name of the job queue.
cjqrsJobQueueName :: Lens' CreateJobQueueResponse Text
cjqrsJobQueueName =
  lens _cjqrsJobQueueName (\s a -> s { _cjqrsJobQueueName = a })
