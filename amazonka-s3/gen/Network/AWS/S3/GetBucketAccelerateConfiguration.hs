...
data GetBucketAccelerateConfiguration = GetBucketAccelerateConfiguration'{_gbacExpectedBucketOwner
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _gbacBucket
...
getBucketAccelerateConfiguration
  ...
  -> GetBucketAccelerateConfiguration
getBucketAccelerateConfiguration pBucket_ = GetBucketAccelerateConfiguration'
  { _gbacExpectedBucketOwner = Nothing
...
gbacExpectedBucketOwner =
  lens _gbacExpectedBucketOwner (\s a -> s { _gbacExpectedBucketOwner = a })
...
instance ToHeaders GetBucketAccelerateConfiguration
  ...
  toHeaders GetBucketAccelerateConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gbacExpectedBucketOwner]
...
grsResponseStatus =
  lens _grsResponseStatus (\s a -> s { _grsResponseStatus = a })
