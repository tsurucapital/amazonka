...
data PutBucketInventoryConfiguration = PutBucketInventoryConfiguration'{_pbicExpectedBucketOwner
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _pbicBucket
...
putBucketInventoryConfiguration pBucket_ pId_ pInventoryConfiguration_ =
  PutBucketInventoryConfiguration'
    { _pbicExpectedBucketOwner    = Nothing
...
pbicExpectedBucketOwner =
  lens _pbicExpectedBucketOwner (\s a -> s { _pbicExpectedBucketOwner = a })
...
pbicInventoryConfiguration = lens
  _pbicInventoryConfiguration
  (\s a -> s { _pbicInventoryConfiguration = a })
...
instance ToHeaders PutBucketInventoryConfiguration
  ...
  toHeaders PutBucketInventoryConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _pbicExpectedBucketOwner]
