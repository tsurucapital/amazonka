...
data PutObjectLegalHold = PutObjectLegalHold'{_polhLegalHold
...
putObjectLegalHold
  ...
  -> ObjectKey -- ^ 'polhKey'
  -> PutObjectLegalHold
putObjectLegalHold pBucket_ pKey_ = PutObjectLegalHold'
...
polhExpectedBucketOwner =
  lens _polhExpectedBucketOwner (\s a -> s { _polhExpectedBucketOwner = a })
...
instance ToHeaders PutObjectLegalHold where
  toHeaders PutObjectLegalHold' {..} = mconcat
...
data PutObjectLegalHoldResponse = PutObjectLegalHoldResponse'{_polhrsRequestCharged
                                                              ::
                                                              !(Maybe
                                                                  RequestCharged),
                                                              _polhrsResponseStatus
                                                              :: !Int}
...
putObjectLegalHoldResponse
  ...
  -> PutObjectLegalHoldResponse
putObjectLegalHoldResponse pResponseStatus_ = PutObjectLegalHoldResponse'
...
polhrsRequestCharged =
  lens _polhrsRequestCharged (\s a -> s { _polhrsRequestCharged = a })

-- | -- | The response status code.
polhrsResponseStatus :: Lens' PutObjectLegalHoldResponse Int
polhrsResponseStatus =
  lens _polhrsResponseStatus (\s a -> s { _polhrsResponseStatus = a })
