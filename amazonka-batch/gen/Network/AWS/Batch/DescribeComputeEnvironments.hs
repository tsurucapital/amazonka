...
dceComputeEnvironments =
  lens _dceComputeEnvironments (\s a -> s { _dceComputeEnvironments = a })
    . _Default
    . _Coerce
...
instance AWSPager DescribeComputeEnvironments where
  page rq rs | stop (rs ^. drsNextToken) = Nothing
...
instance AWSRequest DescribeComputeEnvironments where
  type Rs DescribeComputeEnvironments = DescribeComputeEnvironmentsResponse
...
instance ToJSON DescribeComputeEnvironments where
  toJSON DescribeComputeEnvironments' {..} = object
    (catMaybes
...
describeComputeEnvironmentsResponse pResponseStatus_ =
  DescribeComputeEnvironmentsResponse' { _drsComputeEnvironments = Nothing
...
drsComputeEnvironments
  :: Lens' DescribeComputeEnvironmentsResponse [ComputeEnvironmentDetail]
drsComputeEnvironments =
