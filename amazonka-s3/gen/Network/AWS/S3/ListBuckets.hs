...
listBucketsResponse
  ...
  -> ListBucketsResponse
listBucketsResponse pResponseStatus_ = ListBucketsResponse'
...
lbrsBuckets =
  lens _lbrsBuckets (\s a -> s { _lbrsBuckets = a }) . _Default . _Coerce
...
lbrsResponseStatus =
  lens _lbrsResponseStatus (\s a -> s { _lbrsResponseStatus = a })
