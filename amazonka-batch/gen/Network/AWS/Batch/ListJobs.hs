...
listJobs :: ListJobs
listJobs = ListJobs' { _ljNextToken      = Nothing
...
instance AWSPager ListJobs where
  page rq rs | stop (rs ^. ljrsNextToken) = Nothing
...
listJobsResponse
  ...
  -> ListJobsResponse
listJobsResponse pResponseStatus_ = ListJobsResponse'
...
ljrsJobSummaryList =
  lens _ljrsJobSummaryList (\s a -> s { _ljrsJobSummaryList = a }) . _Coerce
