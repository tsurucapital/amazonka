...
data DeleteBucketMetricsConfiguration = DeleteBucketMetricsConfiguration'{_dbmcExpectedBucketOwner
                                                                          ::
                                                                          !(Maybe
                                                                              Text),
                                                                          _dbmcBucket
...
deleteBucketMetricsConfiguration pBucket_ pId_ =
  DeleteBucketMetricsConfiguration' { _dbmcExpectedBucketOwner = Nothing
...
dbmcExpectedBucketOwner =
  lens _dbmcExpectedBucketOwner (\s a -> s { _dbmcExpectedBucketOwner = a })
...
instance ToHeaders DeleteBucketMetricsConfiguration
  ...
  toHeaders DeleteBucketMetricsConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _dbmcExpectedBucketOwner]
