...
data IntelligentTieringConfiguration = IntelligentTieringConfiguration'{_itcFilter
                                                                        ::
                                                                        !(Maybe
...
intelligentTieringConfiguration pId_ pStatus_ =
  IntelligentTieringConfiguration' { _itcFilter   = Nothing
                                   , _itcId       = pId_
                                   , _itcStatus   = pStatus_
                                   , _itcTierings = mempty
                                   }
...
itcFilter
  :: Lens' IntelligentTieringConfiguration (Maybe IntelligentTieringFilter)
...
instance ToXML IntelligentTieringConfiguration where
  toXML IntelligentTieringConfiguration' {..} = mconcat
    [ "Filter" @= _itcFilter
    , "Id" @= _itcId
    , "Status" @= _itcStatus
