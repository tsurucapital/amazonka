...
data GetBucketIntelligentTieringConfiguration = GetBucketIntelligentTieringConfiguration'{_gbitcBucket
                                                                                          ::
                                                                                          !BucketName,
                                                                                          _gbitcId
                                                                                          ::
...
getBucketIntelligentTieringConfiguration
  :: BucketName -- ^ 'gbitcBucket'
  -> Text -- ^ 'gbitcId'
  -> GetBucketIntelligentTieringConfiguration
getBucketIntelligentTieringConfiguration pBucket_ pId_ =
  GetBucketIntelligentTieringConfiguration' { _gbitcBucket = pBucket_
                                            , _gbitcId     = pId_
                                            }
...
data GetBucketIntelligentTieringConfigurationResponse = GetBucketIntelligentTieringConfigurationResponse'{_gbitcrsIntelligentTieringConfiguration
                                                                                                          ::
                                                                                                          !(Maybe
...
getBucketIntelligentTieringConfigurationResponse
  :: Int -- ^ 'gbitcrsResponseStatus'
  -> GetBucketIntelligentTieringConfigurationResponse
getBucketIntelligentTieringConfigurationResponse pResponseStatus_ =
  GetBucketIntelligentTieringConfigurationResponse'
    { _gbitcrsIntelligentTieringConfiguration = Nothing
...
gbitcrsIntelligentTieringConfiguration = lens
  _gbitcrsIntelligentTieringConfiguration
  (\s a -> s { _gbitcrsIntelligentTieringConfiguration = a })

-- | -- | The response status code.
gbitcrsResponseStatus
  :: Lens' GetBucketIntelligentTieringConfigurationResponse Int
gbitcrsResponseStatus =
  lens _gbitcrsResponseStatus (\s a -> s { _gbitcrsResponseStatus = a })
