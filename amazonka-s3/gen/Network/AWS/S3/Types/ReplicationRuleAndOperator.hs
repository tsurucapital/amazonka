...
data ReplicationRuleAndOperator = ReplicationRuleAndOperator'{_rraoPrefix
                                                              :: !(Maybe Text),
                                                              _rraoTags ::
                                                              !(Maybe [Tag])}
...
instance ToXML ReplicationRuleAndOperator where
  toXML ReplicationRuleAndOperator' {..} = mconcat
    ["Prefix" @= _rraoPrefix, "Tag" @= toXML (toXMLList "Tag" <$> _rraoTags)]
