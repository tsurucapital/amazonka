...
data DeleteBucketTagging = DeleteBucketTagging'{_dbtExpectedBucketOwner
                                                :: !(Maybe Text),
...
deleteBucketTagging
  ...
  -> DeleteBucketTagging
deleteBucketTagging pBucket_ = DeleteBucketTagging'
...
dbtExpectedBucketOwner =
  lens _dbtExpectedBucketOwner (\s a -> s { _dbtExpectedBucketOwner = a })
...
instance ToHeaders DeleteBucketTagging where
  toHeaders DeleteBucketTagging' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _dbtExpectedBucketOwner]
