...
data DeleteBucketAnalyticsConfiguration = DeleteBucketAnalyticsConfiguration'{_dbacExpectedBucketOwner
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _dbacBucket
...
deleteBucketAnalyticsConfiguration pBucket_ pId_ =
  DeleteBucketAnalyticsConfiguration' { _dbacExpectedBucketOwner = Nothing
...
dbacExpectedBucketOwner =
  lens _dbacExpectedBucketOwner (\s a -> s { _dbacExpectedBucketOwner = a })
...
instance ToHeaders DeleteBucketAnalyticsConfiguration
  ...
  toHeaders DeleteBucketAnalyticsConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _dbacExpectedBucketOwner]
