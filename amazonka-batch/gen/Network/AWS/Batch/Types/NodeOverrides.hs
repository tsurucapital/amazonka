...
data NodeOverrides = NodeOverrides'{_noNumNodes ::
                                    !(Maybe Int),
...
nodeOverrides =
  NodeOverrides' { _noNumNodes = Nothing, _noNodePropertyOverrides = Nothing }
...
noNodePropertyOverrides =
  lens _noNodePropertyOverrides (\s a -> s { _noNodePropertyOverrides = a })
    . _Default
    . _Coerce
