...
data ListObjectVersions = ListObjectVersions'{_lKeyMarker
                                              :: !(Maybe Text),
                                              _lPrefix :: !(Maybe Text),
                                              _lEncodingType ::
                                              !(Maybe EncodingType),
...
listObjectVersions
  :: BucketName -- ^ 'lBucket'
  -> ListObjectVersions
listObjectVersions pBucket_ = ListObjectVersions'
  { _lKeyMarker           = Nothing
  , _lPrefix              = Nothing
...
lExpectedBucketOwner =
  lens _lExpectedBucketOwner (\s a -> s { _lExpectedBucketOwner = a })
...
data ListObjectVersionsResponse = ListObjectVersionsResponse'{_lrsNextVersionIdMarker
                                                              :: !(Maybe Text),
                                                              _lrsKeyMarker ::
                                                              !(Maybe Text),
                                                              _lrsDeleteMarkers
...
listObjectVersionsResponse
  ...
  -> ListObjectVersionsResponse
listObjectVersionsResponse pResponseStatus_ = ListObjectVersionsResponse'
...
lrsNextVersionIdMarker =
  lens _lrsNextVersionIdMarker (\s a -> s { _lrsNextVersionIdMarker = a })
...
lrsDeleteMarkers =
  lens _lrsDeleteMarkers (\s a -> s { _lrsDeleteMarkers = a })
    . _Default
    . _Coerce
...
lrsCommonPrefixes =
  lens _lrsCommonPrefixes (\s a -> s { _lrsCommonPrefixes = a })
    . _Default
    . _Coerce
...
lrsVersions =
  lens _lrsVersions (\s a -> s { _lrsVersions = a }) . _Default . _Coerce
...
lrsVersionIdMarker =
  lens _lrsVersionIdMarker (\s a -> s { _lrsVersionIdMarker = a })
...
lrsResponseStatus =
  lens _lrsResponseStatus (\s a -> s { _lrsResponseStatus = a })
