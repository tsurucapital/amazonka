...
data PutBucketNotificationConfiguration = PutBucketNotificationConfiguration'{_pbncExpectedBucketOwner
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _pbncBucket
...
putBucketNotificationConfiguration pBucket_ pNotificationConfiguration_ =
  PutBucketNotificationConfiguration'
    { _pbncExpectedBucketOwner       = Nothing
...
pbncExpectedBucketOwner =
  lens _pbncExpectedBucketOwner (\s a -> s { _pbncExpectedBucketOwner = a })
...
-- | Undocumented member.
pbncNotificationConfiguration
  :: Lens' PutBucketNotificationConfiguration NotificationConfiguration
pbncNotificationConfiguration = lens
  _pbncNotificationConfiguration
...
instance ToHeaders PutBucketNotificationConfiguration
  ...
  toHeaders PutBucketNotificationConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _pbncExpectedBucketOwner]
