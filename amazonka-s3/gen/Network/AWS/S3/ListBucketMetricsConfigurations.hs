...
listBucketMetricsConfigurations
  ...
  -> ListBucketMetricsConfigurations
listBucketMetricsConfigurations pBucket_ = ListBucketMetricsConfigurations'
...
lbmcContinuationToken =
  lens _lbmcContinuationToken (\s a -> s { _lbmcContinuationToken = a })

-- | The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP @403 (Access Denied)@ error.
lbmcExpectedBucketOwner :: Lens' ListBucketMetricsConfigurations (Maybe Text)
lbmcExpectedBucketOwner =
  lens _lbmcExpectedBucketOwner (\s a -> s { _lbmcExpectedBucketOwner = a })
...
instance ToHeaders ListBucketMetricsConfigurations
  ...
  toHeaders ListBucketMetricsConfigurations' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _lbmcExpectedBucketOwner]
...
instance ToQuery ListBucketMetricsConfigurations
  ...
  toQuery ListBucketMetricsConfigurations' {..} =
    mconcat ["continuation-token" =: _lbmcContinuationToken, "metrics"]
...
lbmcrsContinuationToken
  :: Lens' ListBucketMetricsConfigurationsResponse (Maybe Text)
lbmcrsContinuationToken =
  lens _lbmcrsContinuationToken (\s a -> s { _lbmcrsContinuationToken = a })

-- | The list of metrics configurations for a bucket.
lbmcrsMetricsConfigurationList
  :: Lens' ListBucketMetricsConfigurationsResponse [MetricsConfiguration]
lbmcrsMetricsConfigurationList =
  lens _lbmcrsMetricsConfigurationList
       (\s a -> s { _lbmcrsMetricsConfigurationList = a })
    . _Default
    . _Coerce
