...
data GetBucketCORS = GetBucketCORS'{_gbcExpectedBucketOwner
                                    :: !(Maybe Text),
...
gbcExpectedBucketOwner =
  lens _gbcExpectedBucketOwner (\s a -> s { _gbcExpectedBucketOwner = a })
...
instance ToHeaders GetBucketCORS where
  toHeaders GetBucketCORS' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gbcExpectedBucketOwner]
...
getBucketCORSResponse
  ...
  -> GetBucketCORSResponse
getBucketCORSResponse pResponseStatus_ = GetBucketCORSResponse'
...
gbcrsCORSRules =
  lens _gbcrsCORSRules (\s a -> s { _gbcrsCORSRules = a }) . _Default . _Coerce

-- | -- | The response status code.
gbcrsResponseStatus :: Lens' GetBucketCORSResponse Int
gbcrsResponseStatus =
  lens _gbcrsResponseStatus (\s a -> s { _gbcrsResponseStatus = a })
