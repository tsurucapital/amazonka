...
aimuDaysAfterInitiation =
  lens _aimuDaysAfterInitiation (\s a -> s { _aimuDaysAfterInitiation = a })
...
instance ToXML AccelerateConfiguration where
  toXML AccelerateConfiguration' {..} = mconcat ["Status" @= _acStatus]
...
instance ToXML AccessControlPolicy where
  toXML AccessControlPolicy' {..} = mconcat
...
instance ToXML AccessControlTranslation where
  toXML AccessControlTranslation' {..} = mconcat ["Owner" @= _actOwner]
...
instance ToXML AnalyticsAndOperator where
  toXML AnalyticsAndOperator' {..} = mconcat
    ["Prefix" @= _aaoPrefix, "Tag" @= toXML (toXMLList "Tag" <$> _aaoTags)]
...
analyticsConfiguration
  ...
  -> AnalyticsConfiguration
analyticsConfiguration pId_ pStorageClassAnalysis_ = AnalyticsConfiguration'
  { _acFilter               = Nothing
  , _acId                   = pId_
...
acStorageClassAnalysis =
  lens _acStorageClassAnalysis (\s a -> s { _acStorageClassAnalysis = a })
...
instance ToXML AnalyticsConfiguration where
  toXML AnalyticsConfiguration' {..} = mconcat
    [ "Filter" @= _acFilter
    , "Id" @= _acId
...
analyticsExportDestination
  ...
  -> AnalyticsExportDestination
analyticsExportDestination pS3BucketDestination_ = AnalyticsExportDestination'
...
aedS3BucketDestination
  :: Lens' AnalyticsExportDestination AnalyticsS3BucketDestination
aedS3BucketDestination =
  lens _aedS3BucketDestination (\s a -> s { _aedS3BucketDestination = a })

instance FromXML AnalyticsExportDestination where
  parseXML x = AnalyticsExportDestination' <$> (x .@ "S3BucketDestination")
...
instance FromXML AnalyticsFilter where
  parseXML x =
    AnalyticsFilter' <$> (x .@? "Tag") <*> (x .@? "Prefix") <*> (x .@? "And")
...
analyticsS3BucketDestination
  ...
  -> AnalyticsS3BucketDestination
analyticsS3BucketDestination pFormat_ pBucket_ = AnalyticsS3BucketDestination'
...
asbdBucketAccountId =
  lens _asbdBucketAccountId (\s a -> s { _asbdBucketAccountId = a })
...
instance ToXML AnalyticsS3BucketDestination where
  toXML AnalyticsS3BucketDestination' {..} = mconcat
...
instance ToXML CORSConfiguration where
  toXML CORSConfiguration' {..} = mconcat [toXMLList "CORSRule" _ccCORSRules]
...
corsRule :: CORSRule
corsRule = CORSRule' { _crMaxAgeSeconds  = Nothing
...
crAllowedHeaders =
  lens _crAllowedHeaders (\s a -> s { _crAllowedHeaders = a })
    . _Default
    . _Coerce
...
crExposeHeaders =
  lens _crExposeHeaders (\s a -> s { _crExposeHeaders = a })
    . _Default
    . _Coerce
...
crAllowedMethods =
  lens _crAllowedMethods (\s a -> s { _crAllowedMethods = a }) . _Coerce

-- | One or more origins you want customers to be able to access the bucket from.
crAllowedOrigins :: Lens' CORSRule [Text]
crAllowedOrigins =
  lens _crAllowedOrigins (\s a -> s { _crAllowedOrigins = a }) . _Coerce
...
csvOutput :: CSVOutput
csvOutput = CSVOutput' { _coQuoteCharacter       = Nothing
...
coRecordDelimiter =
  lens _coRecordDelimiter (\s a -> s { _coRecordDelimiter = a })

-- | Single character used for escaping the quote character inside an already escaped value.
coQuoteEscapeCharacter :: Lens' CSVOutput (Maybe Text)
coQuoteEscapeCharacter =
  lens _coQuoteEscapeCharacter (\s a -> s { _coQuoteEscapeCharacter = a })
...
condition :: Condition
condition = Condition' { _cKeyPrefixEquals             = Nothing
...
cHTTPErrorCodeReturnedEquals = lens
...
corLastModified =
  lens _corLastModified (\s a -> s { _corLastModified = a }) . mapping _Time

instance FromXML CopyObjectResult where
  parseXML x = CopyObjectResult' <$> (x .@? "ETag") <*> (x .@? "LastModified")
...
cprLastModified =
  lens _cprLastModified (\s a -> s { _cprLastModified = a }) . mapping _Time

instance FromXML CopyPartResult where
  parseXML x = CopyPartResult' <$> (x .@? "ETag") <*> (x .@? "LastModified")
...
cbcLocationConstraint
  :: Lens' CreateBucketConfiguration (Maybe LocationConstraint)
cbcLocationConstraint =
...
deleteMarkerEntry = DeleteMarkerEntry' { _dmeVersionId    = Nothing
...
dmeLastModified =
  lens _dmeLastModified (\s a -> s { _dmeLastModified = a }) . mapping _Time
...
deletedObject = DeletedObject' { _dVersionId             = Nothing
...
dDeleteMarkerVersionId =
  lens _dDeleteMarkerVersionId (\s a -> s { _dDeleteMarkerVersionId = a })
...
destination
  :: BucketName -- ^ 'dBucket'
  -> Destination
destination pBucket_ = Destination' { _dAccessControlTranslation = Nothing
                                    , _dAccount                  = Nothing
...
dAccessControlTranslation =
  lens _dAccessControlTranslation (\s a -> s { _dAccessControlTranslation = a })
...
dEncryptionConfiguration =
  lens _dEncryptionConfiguration (\s a -> s { _dEncryptionConfiguration = a })
...
encryption
  ...
  -> Encryption
encryption pEncryptionType_ = Encryption' { _eKMSKeyId       = Nothing
...
ecReplicaKMSKeyId =
  lens _ecReplicaKMSKeyId (\s a -> s { _ecReplicaKMSKeyId = a })
...
instance ToXML FilterRule where
  toXML FilterRule' {..} = mconcat ["Value" @= _frValue, "Name" @= _frName]
...
grantee
  :: Type -- ^ 'gType'
  -> Grantee
grantee pType_ = Grantee' { _gURI          = Nothing
...
inputSerialization = InputSerialization' { _isJSON            = Nothing
                                         , _isCSV             = Nothing
...
isCompressionType =
  lens _isCompressionType (\s a -> s { _isCompressionType = a })
...
instance ToXML InputSerialization where
  toXML InputSerialization' {..} = mconcat
    [ "JSON" @= _isJSON
    , "CSV" @= _isCSV
...
icOptionalFields =
  lens _icOptionalFields (\s a -> s { _icOptionalFields = a })
    . _Default
    . _Coerce
...
icIncludedObjectVersions
  :: Lens' InventoryConfiguration InventoryIncludedObjectVersions
icIncludedObjectVersions =
  lens _icIncludedObjectVersions (\s a -> s { _icIncludedObjectVersions = a })
...
instance ToXML InventoryConfiguration where
  toXML InventoryConfiguration' {..} = mconcat
    [ "OptionalFields" @= toXML (toXMLList "Field" <$> _icOptionalFields)
    , "Filter" @= _icFilter
...
idS3BucketDestination =
  lens _idS3BucketDestination (\s a -> s { _idS3BucketDestination = a })
...
instance FromXML InventoryEncryption where
  parseXML x = InventoryEncryption' <$> (x .@? "SSE-S3") <*> (x .@? "SSE-KMS")
...
inventoryS3BucketDestination
  ...
  -> InventoryS3BucketDestination
inventoryS3BucketDestination pBucket_ pFormat_ = InventoryS3BucketDestination'
  { _isbdPrefix     = Nothing
...
instance ToXML InventoryS3BucketDestination where
  toXML InventoryS3BucketDestination' {..} = mconcat
    [ "Prefix" @= _isbdPrefix
...
instance ToXML InventorySchedule where
  toXML InventorySchedule' {..} = mconcat ["Frequency" @= _isFrequency]
...
joRecordDelimiter =
  lens _joRecordDelimiter (\s a -> s { _joRecordDelimiter = a })
...
instance ToXML JSONOutput where
  toXML JSONOutput' {..} = mconcat ["RecordDelimiter" @= _joRecordDelimiter]
...
lambdaFunctionConfiguration
  ...
  -> LambdaFunctionConfiguration
lambdaFunctionConfiguration pLambdaFunctionARN_ = LambdaFunctionConfiguration'
  { _lfcId                = Nothing
  , _lfcFilter            = Nothing
...
-- | Undocumented member.
lfcFilter
  :: Lens' LambdaFunctionConfiguration (Maybe NotificationConfigurationFilter)
...
instance ToXML LambdaFunctionConfiguration where
  toXML LambdaFunctionConfiguration' {..} = mconcat
    [ "Id" @= _lfcId
    , "Filter" @= _lfcFilter
...
leExpiredObjectDeleteMarker = lens
  _leExpiredObjectDeleteMarker
  (\s a -> s { _leExpiredObjectDeleteMarker = a })
...
instance ToXML LifecycleExpiration where
  toXML LifecycleExpiration' {..} = mconcat
    [ "Days" @= _leDays
    , "Date" @= _leDate
...
lifecycleRule
  ...
  -> LifecycleRule
lifecycleRule pStatus_ = LifecycleRule'
...
lrTransitions =
  lens _lrTransitions (\s a -> s { _lrTransitions = a }) . _Default . _Coerce

-- | Undocumented member.
lrNoncurrentVersionExpiration
  :: Lens' LifecycleRule (Maybe NoncurrentVersionExpiration)
lrNoncurrentVersionExpiration = lens
  _lrNoncurrentVersionExpiration
  (\s a -> s { _lrNoncurrentVersionExpiration = a })
...
lrNoncurrentVersionTransitions
  :: Lens' LifecycleRule [NoncurrentVersionTransition]
lrNoncurrentVersionTransitions =
  lens _lrNoncurrentVersionTransitions
       (\s a -> s { _lrNoncurrentVersionTransitions = a })
    . _Default
    . _Coerce
...
lrAbortIncompleteMultipartUpload
  :: Lens' LifecycleRule (Maybe AbortIncompleteMultipartUpload)
lrAbortIncompleteMultipartUpload = lens
  _lrAbortIncompleteMultipartUpload
  (\s a -> s { _lrAbortIncompleteMultipartUpload = a })
...
instance ToXML LifecycleRule where
  toXML LifecycleRule' {..} = mconcat
    ...
    , "ID" @= _lrId
    , "Filter" @= _lrFilter
    , "AbortIncompleteMultipartUpload" @= _lrAbortIncompleteMultipartUpload
    , "Status" @= _lrStatus
    ]
...
instance ToXML LifecycleRuleAndOperator where
  toXML LifecycleRuleAndOperator' {..} = mconcat
    ["Prefix" @= _lraoPrefix, "Tag" @= toXML (toXMLList "Tag" <$> _lraoTags)]
...
lifecycleRuleFilter = LifecycleRuleFilter' { _lrfTag    = Nothing
                                           , _lrfPrefix = Nothing
                                           , _lrfAnd    = Nothing
                                           }
...
instance ToXML LifecycleRuleFilter where
  toXML LifecycleRuleFilter' {..} =
    mconcat ["Tag" @= _lrfTag, "Prefix" @= _lrfPrefix, "And" @= _lrfAnd]
...
loggingEnabled
  ...
  -> Text -- ^ 'leTargetPrefix'
  -> LoggingEnabled
loggingEnabled pTargetBucket_ pTargetPrefix_ = LoggingEnabled'
...
leTargetGrants =
  lens _leTargetGrants (\s a -> s { _leTargetGrants = a }) . _Default . _Coerce
...
instance ToXML MetadataEntry where
  toXML MetadataEntry' {..} = mconcat ["Value" @= _meValue, "Name" @= _meName]
...
instance ToXML MetricsAndOperator where
  toXML MetricsAndOperator' {..} = mconcat
    ["Prefix" @= _maoPrefix, "Tag" @= toXML (toXMLList "Tag" <$> _maoTags)]
...
instance FromXML MetricsConfiguration where
  parseXML x = MetricsConfiguration' <$> (x .@? "Filter") <*> (x .@ "Id")
...
instance FromXML MetricsFilter where
  parseXML x =
    MetricsFilter' <$> (x .@? "Tag") <*> (x .@? "Prefix") <*> (x .@? "And")
...
multipartUpload = MultipartUpload' { _muInitiated    = Nothing
...
muInitiated =
  lens _muInitiated (\s a -> s { _muInitiated = a }) . mapping _Time
...
instance FromXML NoncurrentVersionExpiration where
  parseXML x = NoncurrentVersionExpiration' <$> (x .@ "NoncurrentDays")
...
noncurrentVersionTransition pNoncurrentDays_ pStorageClass_ =
  NoncurrentVersionTransition' { _nvtNoncurrentDays = pNoncurrentDays_
...
instance ToXML NoncurrentVersionTransition where
  toXML NoncurrentVersionTransition' {..} = mconcat
    ["NoncurrentDays" @= _nvtNoncurrentDays, "StorageClass" @= _nvtStorageClass]
...
ncLambdaFunctionConfigurations
  :: Lens' NotificationConfiguration [LambdaFunctionConfiguration]
ncLambdaFunctionConfigurations =
...
instance ToXML NotificationConfiguration where
  toXML NotificationConfiguration' {..} = mconcat
...
instance ToXML NotificationConfigurationFilter where
  toXML NotificationConfigurationFilter' {..} = mconcat ["S3Key" @= _ncfKey]
...
object'
  ...
  -> Object
object' pETag_ pSize_ pKey_ pStorageClass_ pLastModified_ = Object'
  { _oOwner        = Nothing
  , _oETag         = pETag_
  , _oSize         = pSize_
  , _oKey          = pKey_
...
objectVersion = ObjectVersion' { _ovETag         = Nothing
...
ovLastModified =
  lens _ovLastModified (\s a -> s { _ovLastModified = a }) . mapping _Time
...
instance ToXML Owner where
  toXML Owner' {..} = mconcat ["DisplayName" @= _oDisplayName, "ID" @= _oId]
...
pLastModified =
  lens _pLastModified (\s a -> s { _pLastModified = a }) . mapping _Time
...
progress :: Progress
progress = Progress' { _pBytesReturned  = Nothing
...
queueConfiguration
  :: Text -- ^ 'qcQueueARN'
  -> QueueConfiguration
queueConfiguration pQueueARN_ = QueueConfiguration' { _qcId       = Nothing
                                                    , _qcFilter   = Nothing
...
instance ToXML QueueConfiguration where
  toXML QueueConfiguration' {..} = mconcat
    [ "Id" @= _qcId
    , "Filter" @= _qcFilter
    , "Queue" @= _qcQueueARN
...
redirect :: Redirect
redirect = Redirect' { _rHostName             = Nothing
                     , _rProtocol             = Nothing
...
instance FromXML RedirectAllRequestsTo where
  parseXML x =
    RedirectAllRequestsTo' <$> (x .@? "Protocol") <*> (x .@ "HostName")
...
instance ToXML RedirectAllRequestsTo where
  toXML RedirectAllRequestsTo' {..} =
    mconcat ["Protocol" @= _rartProtocol, "HostName" @= _rartHostName]
...
instance FromXML ReplicationConfiguration where
  parseXML x =
    ReplicationConfiguration' <$> (x .@ "Role") <*> (parseXMLList "Rule" x)
...
replicationRule
  ...
  -> ReplicationRule
replicationRule pPrefix_ pStatus_ pDestination_ = ReplicationRule'
  { _rrId                      = Nothing
...
rrSourceSelectionCriteria
  :: Lens' ReplicationRule (Maybe SourceSelectionCriteria)
rrSourceSelectionCriteria =
  lens _rrSourceSelectionCriteria (\s a -> s { _rrSourceSelectionCriteria = a })
...
instance ToXML RequestPaymentConfiguration where
  toXML RequestPaymentConfiguration' {..} = mconcat ["Payer" @= _rpcPayer]
...
restoreRequest = RestoreRequest' { _rrDays                 = Nothing
...
rrSelectParameters =
  lens _rrSelectParameters (\s a -> s { _rrSelectParameters = a })
...
rrGlacierJobParameters =
  lens _rrGlacierJobParameters (\s a -> s { _rrGlacierJobParameters = a })
...
instance FromXML RoutingRule where
  parseXML x = RoutingRule' <$> (x .@? "Condition") <*> (x .@ "Redirect")
...
skfFilterRules =
  lens _skfFilterRules (\s a -> s { _skfFilterRules = a }) . _Default . _Coerce
...
s3Location
  ...
  -> Text -- ^ 'slPrefix'
  -> S3Location
s3Location pBucketName_ pPrefix_ = S3Location' { _slCannedACL         = Nothing
...
slAccessControlList =
  lens _slAccessControlList (\s a -> s { _slAccessControlList = a })
    . _Default
    . _Coerce
...
slUserMetadata =
  lens _slUserMetadata (\s a -> s { _slUserMetadata = a }) . _Default . _Coerce
...
instance ToXML S3Location where
  toXML S3Location' {..} = mconcat
    [ "CannedACL" @= _slCannedACL
    , "AccessControlList" @= toXML (toXMLList "Grant" <$> _slAccessControlList)
    , "UserMetadata" @= toXML (toXMLList "MetadataEntry" <$> _slUserMetadata)
...
s3ServiceError = S3ServiceError' { _sseVersionId = Nothing
                                 , _sseKey       = Nothing
                                 , _sseCode      = Nothing
                                 , _sseMessage   = Nothing
                                 }
...
selectParameters pInputSerialization_ pExpressionType_ pExpression_ pOutputSerialization_
  = SelectParameters' { _spInputSerialization  = pInputSerialization_
...
spInputSerialization =
  lens _spInputSerialization (\s a -> s { _spInputSerialization = a })
...
spOutputSerialization =
  lens _spOutputSerialization (\s a -> s { _spOutputSerialization = a })
...
instance ToXML SelectParameters where
  toXML SelectParameters' {..} = mconcat
...
serverSideEncryptionByDefault
  ...
  -> ServerSideEncryptionByDefault
serverSideEncryptionByDefault pSSEAlgorithm_ = ServerSideEncryptionByDefault'
...
ssebdKMSMasterKeyId =
  lens _ssebdKMSMasterKeyId (\s a -> s { _ssebdKMSMasterKeyId = a })
    . mapping _Sensitive

-- | Server-side encryption algorithm to use for the default encryption.
ssebdSSEAlgorithm :: Lens' ServerSideEncryptionByDefault ServerSideEncryption
ssebdSSEAlgorithm =
  lens _ssebdSSEAlgorithm (\s a -> s { _ssebdSSEAlgorithm = a })
...
instance ToXML ServerSideEncryptionByDefault where
  toXML ServerSideEncryptionByDefault' {..} = mconcat
...
instance FromXML ServerSideEncryptionConfiguration
         where
  parseXML x = ServerSideEncryptionConfiguration' <$> (parseXMLList "Rule" x)
...
instance FromXML ServerSideEncryptionRule where
  parseXML x =
    ServerSideEncryptionRule' <$> (x .@? "ApplyServerSideEncryptionByDefault")
...
instance FromXML SourceSelectionCriteria where
  parseXML x = SourceSelectionCriteria' <$> (x .@? "SseKmsEncryptedObjects")
...
instance ToXML SseKMSEncryptedObjects where
  toXML SseKMSEncryptedObjects' {..} = mconcat ["Status" @= _skeoStatus]
...
stats :: Stats
stats = Stats' { _sBytesReturned  = Nothing
...
scaDataExport
  :: Lens' StorageClassAnalysis (Maybe StorageClassAnalysisDataExport)
...
instance ToXML StorageClassAnalysis where
  toXML StorageClassAnalysis' {..} = mconcat ["DataExport" @= _scaDataExport]
...
scadeOutputSchemaVersion
  :: Lens' StorageClassAnalysisDataExport StorageClassAnalysisSchemaVersion
scadeOutputSchemaVersion =
  lens _scadeOutputSchemaVersion (\s a -> s { _scadeOutputSchemaVersion = a })

-- | The place to store the data for an analysis.
scadeDestination
  :: Lens' StorageClassAnalysisDataExport AnalyticsExportDestination
...
instance ToXML StorageClassAnalysisDataExport where
  toXML StorageClassAnalysisDataExport' {..} = mconcat
...
instance FromXML TargetGrant where
  parseXML x = TargetGrant' <$> (x .@? "Permission") <*> (x .@? "Grantee")
...
topicConfiguration
  :: Text -- ^ 'tcTopicARN'
  -> TopicConfiguration
topicConfiguration pTopicARN_ = TopicConfiguration' { _tcId       = Nothing
                                                    , _tcFilter   = Nothing
...
instance ToXML TopicConfiguration where
  toXML TopicConfiguration' {..} = mconcat
    [ "Id" @= _tcId
    , "Filter" @= _tcFilter
    , "Topic" @= _tcTopicARN
...
instance FromXML Transition where
  parseXML x =
    Transition' <$> (x .@? "Days") <*> (x .@? "Date") <*> (x .@? "StorageClass")
...
instance ToXML Transition where
  toXML Transition' {..} = mconcat
    ["Days" @= _tDays, "Date" @= _tDate, "StorageClass" @= _tStorageClass]
...
wcRedirectAllRequestsTo
  :: Lens' WebsiteConfiguration (Maybe RedirectAllRequestsTo)
wcRedirectAllRequestsTo =
...
wcRoutingRules =
  lens _wcRoutingRules (\s a -> s { _wcRoutingRules = a }) . _Default . _Coerce
