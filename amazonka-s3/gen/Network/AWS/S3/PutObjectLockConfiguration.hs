...
data PutObjectLockConfiguration = PutObjectLockConfiguration'{_polcToken
                                                              :: !(Maybe Text),
...
putObjectLockConfiguration
  ...
  -> PutObjectLockConfiguration
putObjectLockConfiguration pBucket_ = PutObjectLockConfiguration'
  { _polcToken                   = Nothing
  , _polcObjectLockConfiguration = Nothing
  , _polcRequestPayer            = Nothing
  , _polcContentMD5              = Nothing
  , _polcExpectedBucketOwner     = Nothing
...
polcObjectLockConfiguration
  :: Lens' PutObjectLockConfiguration (Maybe ObjectLockConfiguration)
polcObjectLockConfiguration = lens
  _polcObjectLockConfiguration
  (\s a -> s { _polcObjectLockConfiguration = a })
...
polcExpectedBucketOwner =
  lens _polcExpectedBucketOwner (\s a -> s { _polcExpectedBucketOwner = a })
...
instance AWSRequest PutObjectLockConfiguration where
  type Rs PutObjectLockConfiguration = PutObjectLockConfigurationResponse
  request  = putXML s3
...
instance ToElement PutObjectLockConfiguration where
  toElement =
    mkElement "{http://s3.amazonaws.com/doc/2006-03-01/}ObjectLockConfiguration"
      . _polcObjectLockConfiguration

instance ToHeaders PutObjectLockConfiguration where
  toHeaders PutObjectLockConfiguration' {..} = mconcat
    [ "x-amz-bucket-object-lock-token" =# _polcToken
    , "x-amz-request-payer" =# _polcRequestPayer
    , "Content-MD5" =# _polcContentMD5
    , "x-amz-expected-bucket-owner" =# _polcExpectedBucketOwner
    ]

instance ToPath PutObjectLockConfiguration where
  toPath PutObjectLockConfiguration' {..} = mconcat ["/", toBS _polcBucket]
...
data PutObjectLockConfigurationResponse = PutObjectLockConfigurationResponse'{_polcrsRequestCharged
                                                                              ::
                                                                              !(Maybe
                                                                                  RequestCharged),
                                                                              _polcrsResponseStatus
                                                                              ::
                                                                              !Int}
...
putObjectLockConfigurationResponse pResponseStatus_ =
  PutObjectLockConfigurationResponse' { _polcrsRequestCharged = Nothing
                                      , _polcrsResponseStatus = pResponseStatus_
                                      }

-- | Undocumented member.
polcrsRequestCharged
  :: Lens' PutObjectLockConfigurationResponse (Maybe RequestCharged)
polcrsRequestCharged =
  lens _polcrsRequestCharged (\s a -> s { _polcrsRequestCharged = a })

-- | -- | The response status code.
polcrsResponseStatus :: Lens' PutObjectLockConfigurationResponse Int
polcrsResponseStatus =
  lens _polcrsResponseStatus (\s a -> s { _polcrsResponseStatus = a })
