...
data NodeProperties = NodeProperties'{_npNumNodes ::
                                      !Int,
                                      _npMainNode :: !Int,
...
nodeProperties
  ...
  -> Int -- ^ 'npMainNode'
  -> NodeProperties
nodeProperties pNumNodes_ pMainNode_ = NodeProperties'
...
npNodeRangeProperties =
  lens _npNodeRangeProperties (\s a -> s { _npNodeRangeProperties = a })
    . _Coerce
