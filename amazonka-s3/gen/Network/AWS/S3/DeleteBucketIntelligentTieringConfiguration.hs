...
data DeleteBucketIntelligentTieringConfiguration = DeleteBucketIntelligentTieringConfiguration'{_dbitcBucket
                                                                                                ::
                                                                                                !BucketName,
                                                                                                _dbitcId
                                                                                                ::
...
deleteBucketIntelligentTieringConfiguration
  :: BucketName -- ^ 'dbitcBucket'
  -> Text -- ^ 'dbitcId'
  -> DeleteBucketIntelligentTieringConfiguration
deleteBucketIntelligentTieringConfiguration pBucket_ pId_ =
  DeleteBucketIntelligentTieringConfiguration' { _dbitcBucket = pBucket_
                                               , _dbitcId     = pId_
                                               }
...
instance AWSRequest
  ...
  type Rs DeleteBucketIntelligentTieringConfiguration
    = DeleteBucketIntelligentTieringConfigurationResponse
  request  = delete s3
  response = receiveNull DeleteBucketIntelligentTieringConfigurationResponse'
