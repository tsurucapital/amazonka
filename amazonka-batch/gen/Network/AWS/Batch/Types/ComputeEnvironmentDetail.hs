...
data ComputeEnvironmentDetail = ComputeEnvironmentDetail'{_cedStatus
                                                          :: !(Maybe CEStatus),
                                                          _cedState ::
                                                          !(Maybe CEState),
...
--
-- * 'cedType' - The type of compute environment: @EC2@ , @SPOT@ , @FARGATE@ , or @FARGATE_SPOT@ . For more information, see <https://docs.aws.amazon.com/batch/latest/userguide/compute_environments.html Compute Environments> in the /AWS Batch User Guide/ .
--
