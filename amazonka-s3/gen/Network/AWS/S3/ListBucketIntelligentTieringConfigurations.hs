...
data ListBucketIntelligentTieringConfigurations = ListBucketIntelligentTieringConfigurations'{_lbitcContinuationToken
                                                                                              ::
                                                                                              !(Maybe
                                                                                                  Text),
                                                                                              _lbitcBucket
...
listBucketIntelligentTieringConfigurations
  :: BucketName -- ^ 'lbitcBucket'
  -> ListBucketIntelligentTieringConfigurations
listBucketIntelligentTieringConfigurations pBucket_ =
  ListBucketIntelligentTieringConfigurations'
    { _lbitcContinuationToken = Nothing
    , _lbitcBucket            = pBucket_
    }

-- | The ContinuationToken that represents a placeholder from where this request should begin.
lbitcContinuationToken
  :: Lens' ListBucketIntelligentTieringConfigurations (Maybe Text)
lbitcContinuationToken =
  lens _lbitcContinuationToken (\s a -> s { _lbitcContinuationToken = a })
...
instance ToQuery
           ListBucketIntelligentTieringConfigurations
         where
  toQuery ListBucketIntelligentTieringConfigurations' {..} = mconcat
    ["continuation-token" =: _lbitcContinuationToken, "intelligent-tiering"]

-- | /See:/ 'listBucketIntelligentTieringConfigurationsResponse' smart constructor.
data ListBucketIntelligentTieringConfigurationsResponse = ListBucketIntelligentTieringConfigurationsResponse'{_lbitcrsIntelligentTieringConfigurationList
                                                                                                              ::
                                                                                                              !(Maybe
...
listBucketIntelligentTieringConfigurationsResponse
  :: Int -- ^ 'lbitcrsResponseStatus'
  -> ListBucketIntelligentTieringConfigurationsResponse
listBucketIntelligentTieringConfigurationsResponse pResponseStatus_ =
  ListBucketIntelligentTieringConfigurationsResponse'
    { _lbitcrsIntelligentTieringConfigurationList = Nothing
...
lbitcrsIntelligentTieringConfigurationList
  :: Lens'
       ...
       [IntelligentTieringConfiguration]
lbitcrsIntelligentTieringConfigurationList =
  lens _lbitcrsIntelligentTieringConfigurationList
       (\s a -> s { _lbitcrsIntelligentTieringConfigurationList = a })
    . _Default
    . _Coerce

-- | The ContinuationToken that represents a placeholder from where this request should begin.
lbitcrsContinuationToken
  :: Lens' ListBucketIntelligentTieringConfigurationsResponse (Maybe Text)
lbitcrsContinuationToken =
  lens _lbitcrsContinuationToken (\s a -> s { _lbitcrsContinuationToken = a })

-- | The marker used to continue this inventory configuration listing. Use the @NextContinuationToken@ from this response to continue the listing in a subsequent request. The continuation token is an opaque value that Amazon S3 understands.
lbitcrsNextContinuationToken
  :: Lens' ListBucketIntelligentTieringConfigurationsResponse (Maybe Text)
lbitcrsNextContinuationToken = lens
  _lbitcrsNextContinuationToken
  (\s a -> s { _lbitcrsNextContinuationToken = a })

-- | Indicates whether the returned list of analytics configurations is complete. A value of true indicates that the list is not complete and the NextContinuationToken will be provided for a subsequent request.
lbitcrsIsTruncated
  :: Lens' ListBucketIntelligentTieringConfigurationsResponse (Maybe Bool)
lbitcrsIsTruncated =
  lens _lbitcrsIsTruncated (\s a -> s { _lbitcrsIsTruncated = a })

-- | -- | The response status code.
lbitcrsResponseStatus
  :: Lens' ListBucketIntelligentTieringConfigurationsResponse Int
lbitcrsResponseStatus =
  lens _lbitcrsResponseStatus (\s a -> s { _lbitcrsResponseStatus = a })
