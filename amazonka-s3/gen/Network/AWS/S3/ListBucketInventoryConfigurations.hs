...
data ListBucketInventoryConfigurations = ListBucketInventoryConfigurations'{_lbicContinuationToken
                                                                            ::
                                                                            !(Maybe
                                                                                Text),
...
listBucketInventoryConfigurations
  ...
  -> ListBucketInventoryConfigurations
listBucketInventoryConfigurations pBucket_ = ListBucketInventoryConfigurations'
...
lbicContinuationToken =
  lens _lbicContinuationToken (\s a -> s { _lbicContinuationToken = a })

-- | The account id of the expected bucket owner. If the bucket is owned by a different account, the request will fail with an HTTP @403 (Access Denied)@ error.
lbicExpectedBucketOwner :: Lens' ListBucketInventoryConfigurations (Maybe Text)
lbicExpectedBucketOwner =
  lens _lbicExpectedBucketOwner (\s a -> s { _lbicExpectedBucketOwner = a })
...
instance ToHeaders ListBucketInventoryConfigurations
  ...
  toHeaders ListBucketInventoryConfigurations' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _lbicExpectedBucketOwner]
...
instance ToQuery ListBucketInventoryConfigurations
  ...
  toQuery ListBucketInventoryConfigurations' {..} =
    mconcat ["continuation-token" =: _lbicContinuationToken, "inventory"]

-- | /See:/ 'listBucketInventoryConfigurationsResponse' smart constructor.
data ListBucketInventoryConfigurationsResponse = ListBucketInventoryConfigurationsResponse'{_lbicrsContinuationToken
                                                                                            ::
                                                                                            !(Maybe
                                                                                                Text),
...
lbicrsContinuationToken
  :: Lens' ListBucketInventoryConfigurationsResponse (Maybe Text)
lbicrsContinuationToken =
  lens _lbicrsContinuationToken (\s a -> s { _lbicrsContinuationToken = a })

-- | The list of inventory configurations for a bucket.
lbicrsInventoryConfigurationList
  :: Lens' ListBucketInventoryConfigurationsResponse [InventoryConfiguration]
lbicrsInventoryConfigurationList =
  lens _lbicrsInventoryConfigurationList
       (\s a -> s { _lbicrsInventoryConfigurationList = a })
    . _Default
    . _Coerce
...
lbicrsNextContinuationToken
  :: Lens' ListBucketInventoryConfigurationsResponse (Maybe Text)
lbicrsNextContinuationToken = lens
  _lbicrsNextContinuationToken
  (\s a -> s { _lbicrsNextContinuationToken = a })

-- | Tells whether the returned list of inventory configurations is complete. A value of true indicates that the list is not complete and the NextContinuationToken is provided for a subsequent request.
lbicrsIsTruncated
  :: Lens' ListBucketInventoryConfigurationsResponse (Maybe Bool)
lbicrsIsTruncated =
  lens _lbicrsIsTruncated (\s a -> s { _lbicrsIsTruncated = a })

-- | -- | The response status code.
lbicrsResponseStatus :: Lens' ListBucketInventoryConfigurationsResponse Int
lbicrsResponseStatus =
  lens _lbicrsResponseStatus (\s a -> s { _lbicrsResponseStatus = a })
