...
data DeleteBucketInventoryConfiguration = DeleteBucketInventoryConfiguration'{_dbicExpectedBucketOwner
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _dbicBucket
...
deleteBucketInventoryConfiguration pBucket_ pId_ =
  DeleteBucketInventoryConfiguration' { _dbicExpectedBucketOwner = Nothing
...
dbicExpectedBucketOwner =
  lens _dbicExpectedBucketOwner (\s a -> s { _dbicExpectedBucketOwner = a })
...
instance ToHeaders DeleteBucketInventoryConfiguration
  ...
  toHeaders DeleteBucketInventoryConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _dbicExpectedBucketOwner]
