...
data PutBucketIntelligentTieringConfiguration = PutBucketIntelligentTieringConfiguration'{_pbitcBucket
                                                                                          ::
                                                                                          !BucketName,
                                                                                          _pbitcId
                                                                                          ::
...
putBucketIntelligentTieringConfiguration
  :: BucketName -- ^ 'pbitcBucket'
  -> Text -- ^ 'pbitcId'
  -> IntelligentTieringConfiguration -- ^ 'pbitcIntelligentTieringConfiguration'
  -> PutBucketIntelligentTieringConfiguration
putBucketIntelligentTieringConfiguration pBucket_ pId_ pIntelligentTieringConfiguration_
  = PutBucketIntelligentTieringConfiguration'
    { _pbitcBucket                          = pBucket_
    , _pbitcId                              = pId_
    , _pbitcIntelligentTieringConfiguration = pIntelligentTieringConfiguration_
    }
...
pbitcIntelligentTieringConfiguration
  :: Lens'
       PutBucketIntelligentTieringConfiguration
       IntelligentTieringConfiguration
pbitcIntelligentTieringConfiguration = lens
  _pbitcIntelligentTieringConfiguration
  (\s a -> s { _pbitcIntelligentTieringConfiguration = a })
...
instance AWSRequest
  ...
  type Rs PutBucketIntelligentTieringConfiguration
    = PutBucketIntelligentTieringConfigurationResponse
  request  = putXML s3
  response = receiveNull PutBucketIntelligentTieringConfigurationResponse'
