...
putBucketVersioning
  ...
  -> PutBucketVersioning
putBucketVersioning pBucket_ pVersioningConfiguration_ = PutBucketVersioning'
  { _pbvMFA                     = Nothing
...
pbvExpectedBucketOwner =
  lens _pbvExpectedBucketOwner (\s a -> s { _pbvExpectedBucketOwner = a })
...
pbvVersioningConfiguration = lens
  _pbvVersioningConfiguration
...
instance ToElement PutBucketVersioning where
  toElement =
    mkElement "{http://s3.amazonaws.com/doc/2006-03-01/}VersioningConfiguration"
      . _pbvVersioningConfiguration
