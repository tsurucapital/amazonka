...
data GetBucketNotificationConfiguration = GetBucketNotificationConfiguration'{_gbncExpectedBucketOwner
                                                                              ::
                                                                              !(Maybe
                                                                                  Text),
                                                                              _gbncBucket
...
getBucketNotificationConfiguration pBucket_ =
  GetBucketNotificationConfiguration' { _gbncExpectedBucketOwner = Nothing
...
gbncExpectedBucketOwner =
  lens _gbncExpectedBucketOwner (\s a -> s { _gbncExpectedBucketOwner = a })
...
instance ToHeaders GetBucketNotificationConfiguration
  ...
  toHeaders GetBucketNotificationConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gbncExpectedBucketOwner]
