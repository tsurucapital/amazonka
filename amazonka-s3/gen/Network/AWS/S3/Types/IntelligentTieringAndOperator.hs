...
data IntelligentTieringAndOperator = IntelligentTieringAndOperator'{_itaoPrefix
                                                                    ::
                                                                    !(Maybe
                                                                        Text),
                                                                    _itaoTags ::
...
instance ToXML IntelligentTieringAndOperator where
  toXML IntelligentTieringAndOperator' {..} = mconcat
    ["Prefix" @= _itaoPrefix, "Tag" @= toXML (toXMLList "Tag" <$> _itaoTags)]
