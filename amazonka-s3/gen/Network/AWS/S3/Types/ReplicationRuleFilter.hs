...
data ReplicationRuleFilter = ReplicationRuleFilter'{_rrfTag
                                                    :: !(Maybe Tag),
...
replicationRuleFilter = ReplicationRuleFilter' { _rrfTag    = Nothing
                                               , _rrfPrefix = Nothing
                                               , _rrfAnd    = Nothing
                                               }
...
instance ToXML ReplicationRuleFilter where
  toXML ReplicationRuleFilter' {..} =
    mconcat ["Tag" @= _rrfTag, "Prefix" @= _rrfPrefix, "And" @= _rrfAnd]
