...
getObjectACL
  ...
  -> ObjectKey -- ^ 'goaKey'
  -> GetObjectACL
getObjectACL pBucket_ pKey_ = GetObjectACL' { _goaVersionId           = Nothing
...
goaExpectedBucketOwner =
  lens _goaExpectedBucketOwner (\s a -> s { _goaExpectedBucketOwner = a })
...
getObjectACLResponse
  ...
  -> GetObjectACLResponse
getObjectACLResponse pResponseStatus_ = GetObjectACLResponse'
