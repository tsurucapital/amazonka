...
data GetBucketLifecycleConfiguration = GetBucketLifecycleConfiguration'{_gblcExpectedBucketOwner
                                                                        ::
                                                                        !(Maybe
                                                                            Text),
                                                                        _gblcBucket
...
getBucketLifecycleConfiguration
  ...
  -> GetBucketLifecycleConfiguration
getBucketLifecycleConfiguration pBucket_ = GetBucketLifecycleConfiguration'
  { _gblcExpectedBucketOwner = Nothing
...
gblcExpectedBucketOwner =
  lens _gblcExpectedBucketOwner (\s a -> s { _gblcExpectedBucketOwner = a })
...
instance ToHeaders GetBucketLifecycleConfiguration
  ...
  toHeaders GetBucketLifecycleConfiguration' {..} =
    mconcat ["x-amz-expected-bucket-owner" =# _gblcExpectedBucketOwner]
...
gblcrsRules =
  lens _gblcrsRules (\s a -> s { _gblcrsRules = a }) . _Default . _Coerce

-- | -- | The response status code.
gblcrsResponseStatus :: Lens' GetBucketLifecycleConfigurationResponse Int
gblcrsResponseStatus =
  lens _gblcrsResponseStatus (\s a -> s { _gblcrsResponseStatus = a })
