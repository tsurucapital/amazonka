...
putObjectTagging
  ...
  -> Tagging -- ^ 'potTagging'
  -> PutObjectTagging
putObjectTagging pBucket_ pKey_ pTagging_ = PutObjectTagging'
...
potExpectedBucketOwner =
  lens _potExpectedBucketOwner (\s a -> s { _potExpectedBucketOwner = a })
...
instance ToHeaders PutObjectTagging where
  toHeaders PutObjectTagging' {..} = mconcat
...
putObjectTaggingResponse
  ...
  -> PutObjectTaggingResponse
putObjectTaggingResponse pResponseStatus_ = PutObjectTaggingResponse'
