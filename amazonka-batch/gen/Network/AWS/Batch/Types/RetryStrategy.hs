...
data RetryStrategy = RetryStrategy'{_rsEvaluateOnExit
...
retryStrategy =
  RetryStrategy' { _rsEvaluateOnExit = Nothing, _rsAttempts = Nothing }
...
rsEvaluateOnExit =
  lens _rsEvaluateOnExit (\s a -> s { _rsEvaluateOnExit = a })
    . _Default
    . _Coerce
