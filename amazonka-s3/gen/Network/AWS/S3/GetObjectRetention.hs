...
data GetObjectRetention = GetObjectRetention'{_gorVersionId
...
getObjectRetention
  ...
  -> ObjectKey -- ^ 'gorKey'
  -> GetObjectRetention
getObjectRetention pBucket_ pKey_ = GetObjectRetention'
...
gorExpectedBucketOwner =
  lens _gorExpectedBucketOwner (\s a -> s { _gorExpectedBucketOwner = a })
...
instance AWSRequest GetObjectRetention where
  ...
  response = receiveXML
    (\s h x ->
      GetObjectRetentionResponse' <$> (parseXML x) <*> (pure (fromEnum s))
    )
...
instance ToHeaders GetObjectRetention where
  toHeaders GetObjectRetention' {..} = mconcat
...
data GetObjectRetentionResponse = GetObjectRetentionResponse'{_gorrsRetention
                                                              ::
                                                              !(Maybe
                                                                  ObjectLockRetention),
...
getObjectRetentionResponse
  ...
  -> GetObjectRetentionResponse
getObjectRetentionResponse pResponseStatus_ = GetObjectRetentionResponse'
...
gorrsResponseStatus =
  lens _gorrsResponseStatus (\s a -> s { _gorrsResponseStatus = a })
